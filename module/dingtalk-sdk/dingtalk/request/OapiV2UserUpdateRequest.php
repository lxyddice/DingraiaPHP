...
class OapiV2UserUpdateRequest
{
	...
	public function setExtAttrs($extAttrs)
	{
		$this->extAttrs = $extAttrs;
		$this->apiParas["ext_attrs"] = $extAttrs;
	}

	public function getExtAttrs()
	{
		return $this->extAttrs;
	}

	public function setExtAttrsUpdateMode($extAttrsUpdateMode)
	{
		$this->extAttrsUpdateMode = $extAttrsUpdateMode;
		$this->apiParas["ext_attrs_update_mode"] = $extAttrsUpdateMode;
	}

	public function getExtAttrsUpdateMode()
	{
		return $this->extAttrsUpdateMode;
	}
